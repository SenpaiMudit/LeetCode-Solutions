...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/find-all-duplicates-in-an-array/)
...
**My Solution:** [442-Find-All-Duplicates-in-an-Array.py](./442-Find-All-Duplicates-in-an-Array.py)
